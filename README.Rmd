...
| `mean1.1996BS`       | Bai & Saranadasa (1996) | $\mu_x = \mu_0$ (1-sample) |
| `mean1.2008SD`| Srivastava & Du (2008)  | $\mu_x = \mu_0$ (1-sample) |
| `mean2.1931Hotelling` | Hotelling (1931)       | $\mu_x = \mu_y$ (2-sample) |
| `mean2.1958Dempster`  | Dempster (1958, 1960)  | $\mu_x = \mu_y$ (2-sample) |
| `mean2.1996BS`       | Bai & Saranadasa (1996) | $\mu_x = \mu_y$ (2-sample) |
| `mean2.2008SD`| Srivastava & Du (2008)  | $\mu_x = \mu_y$ (2-sample) |
...
| `vark.1974BF`    | Brown & Forsythe (1974) | $\sigma_1^2 = \cdots = \sigma_k^2$ ($k$-sample) |
