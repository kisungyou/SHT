...
| function name | authors | description of $H_0$|
|---------------|------------------------|:----------------|
| `norm.1987JB` | Jarque and Bera (1987) | $F(X) = \textrm{Normal} \in \mathbb{R}^1$|
| `norm.1996AJB`| Urzua (1996) | $F(X) = \textrm{Normal} \in \mathbb{R}^1$|
| `norm.2008RJB` | Gel and Gastwirth (2008) | $F(X) = \textrm{Normal} \in \mathbb{R}^1$|
